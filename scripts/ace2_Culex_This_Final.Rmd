...
summary_sites <- countsDf %>%
  select(site, pp, pq, qq, N, latitude, longitude, h_index, predicted_h_index, HWE_p_value, predicted_overlap, zone)
...
countsDf$zone <- factor(countsDf$zone, levels = c("West Coast", "Mtn/Southwest", "Central", "East Coast", "Other"))
